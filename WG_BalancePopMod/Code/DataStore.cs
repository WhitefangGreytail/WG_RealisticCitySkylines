...
namespace WG_BalancedPopMod
{
    public class DataStore
    {
        ...
        public static int[][] industry_farm = { new int [] {  40, 90, 10, 0, 0,  75, 200, 225, 30, 170, 0, 175},
                                                new int [] { 100, 45, 50, 5, 0, 120, 400, 500, 50, 200, 0, 180} };

        public static int[][] industry_forest = { new int [] {  40, 90, 10, 0, 0,  90, 30, 40, 40, 170, 0, 210},
                                                  new int [] { 100, 40, 55, 5, 0, 130, 75, 80, 50, 210, 0, 200} };

        public static int[][] industry_ore = { new int [] { 100, 18, 60, 20,  2, 180, 200, 200, 80, 220, 400, 500},
                                               new int [] { 150, 15, 40, 35, 10, 240, 210, 280, 60, 300, 300, 475} };

        public static int[][] industry_oil = { new int [] { 100, 15, 60, 23,  2, 200, 200, 250, 60, 300, 450, 375},
                                               new int [] { 150, 15, 35, 40, 10, 280, 220, 300, 75, 350, 300, 400} };
    }
}