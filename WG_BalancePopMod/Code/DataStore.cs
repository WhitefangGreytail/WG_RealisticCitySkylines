...
namespace WG_BalancedPopMod
{
    public class DataStore
    {
        ...
        public static int[][] commercialLow = { new int [] {150, 7, 2,   90, 10,  0,  0,   28, 40, 40, 11, 650,   0, 100,   -1},
                                                new int [] {110, 6, 1,   35, 40, 20,  5,   32, 45, 45, 10, 700,   0,  90,   -1},
                                                new int [] {115, 5, 1,   15, 30, 40, 15,   36, 50, 50,  9, 750,   0,  75,   -1} };

        public static int[][] commercialHigh = { new int [] {110, 5, 1,   20, 40, 30,  5,   30, 45, 45, 11, 700,   0, 80,   -1},
                                                 new int [] {120, 5, 1,   15, 35, 35, 15,   34, 50, 50, 10, 750,   0, 70,   -1},
                                                 new int [] {130, 5, 1,   10, 25, 40, 25,   38, 55, 55,  9, 800,   0, 60,   -1} };
        ...
        public static int[][] office = { new int [] {35, 5, 0,   3, 17, 40, 40,    80, 14, 13, 10, 2000,   0, 1,   20},
                                         new int [] {37, 5, 0,   3, 10, 24, 63,    90, 15, 14, 10, 2200,   0, 1,   20},
                                         new int [] {40, 5, 0,   3,  4,  8, 85,   100, 16, 15,  9, 2400,   0, 1,   20} };

        // Very high floor level because chimney stacks count to height level
        public static int[][] industry = { new int [] {38, 50, 0,   90, 10,  0,  0,   100, 100, 120, 50, 170,   300, 300,   100},
        ...
        public static int[][] industry_forest = { new int [] {150, 20, 0,   90, 10, 0, 0,    90, 30, 40, 40, 180,   0, 210,    25},
                                                  new int [] { 45, 20, 0,   40, 55, 5, 0,   130, 75, 80, 50, 220,   0, 200,   100} };
        ...
        public static int[][] industry_oil = { new int [] {80, 30, 0,   15, 60, 23,  2,   200, 200, 250, 60, 300,   450, 375,    75},
                                               new int [] {38, 30, 0,   15, 35, 40, 10,   280, 220, 300, 75, 380,   300, 400,   100} };
    } // end DataStore
