...
namespace WG_BalancedPopMod
{
    public class DataStore
    {
        ...
        public static int[][] residentialLow = { new int [] {2000, 50, -1,   -1, -1, -1, -1,   10, 24, 18, 14, 120,   0, 1,   -1},
                                                 new int [] {2000, 50, -1,   -1, -1, -1, -1,   12, 26, 20, 13, 140,   0, 1,   -1},
                                                 new int [] {2000, 50, -1,   -1, -1, -1, -1,   14, 28, 22, 12, 160,   0, 1,   -1},
                                                 new int [] {2000, 50, -1,   -1, -1, -1, -1,   16, 31, 25, 11, 180,   0, 1,   -1},
                                                 new int [] {2000, 50, -1,   -1, -1, -1, -1,   18, 34, 28, 10, 200,   0, 1,   -1} };

        public static int[][] residentialHigh = { new int [] {150, 5, -1,   -1, -1, -1, -1,    8, 20, 16, 11,  96,   0, 5,   -1},
                                                  new int [] {160, 5, -1,   -1, -1, -1, -1,   10, 22, 18, 10, 112,   0, 5,   -1},
                                                  new int [] {170, 5, -1,   -1, -1, -1, -1,   12, 24, 20,  9, 128,   0, 5,   -1},
                                                  new int [] {180, 5, -1,   -1, -1, -1, -1,   14, 27, 23,  8, 144,   0, 5,   -1},
                                                  new int [] {190, 5, -1,   -1, -1, -1, -1,   16, 30, 26,  7, 160,   0, 5,   -1} };

        // High floor levels to help with maintaining a single story 
        public static int[][] commercialLow = { new int [] { 90, 5, 1,   70, 20, 10,  0,   28, 40, 40, 11, 700,   0, 100,   -1},
                                                new int [] { 95, 5, 1,   30, 45, 20,  5,   32, 45, 45, 10, 750,   0,  90,   -1},
                                                new int [] {100, 5, 1,    5, 30, 55, 10,   36, 50, 50,  9, 800,   0,  75,   -1} };

        public static int[][] commercialHigh = { new int [] {110, 5, 1,   10, 45, 40,  5,   30, 45, 45, 11, 750,   0, 80,   -1},
                                                 new int [] {115, 5, 1,    7, 32, 43, 18,   34, 50, 50, 10, 800,   0, 70,   -1},
                                                 new int [] {120, 5, 1,    5, 25, 45, 25,   38, 55, 55,  9, 850,   0, 60,   -1} };
        ...
        public static int[][] commercialTourist = { new int[] {1200, 10, 50,   15, 35, 35, 15,   40, 60, 65, 40, 750,   0, 150,   -1 } };
        ...
        public static int[][] office = { new int [] {34, 5, 0,   2,  8, 20, 70,   24, 12, 11, 9, 1800,   0, 1,   20},
                                         new int [] {37, 5, 0,   1,  5, 14, 80,   27, 13, 12, 9, 1925,   0, 1,   20},
                                         new int [] {40, 5, 0,   1,  3,  6, 90,   32, 14, 13, 8, 2100,   0, 1,   20} };

        // Very high floor level because chimney stacks count to height level
        public static int[][] industry = { new int [] {38, 50, 0,   70, 20, 10,  0,   100, 100, 120, 50, 180,   300, 300,   100},
                                           new int [] {35, 50, 0,   20, 45, 25, 10,   150, 130, 150, 48, 210,   150, 150,   140},
                                           new int [] {32, 50, 0,    5, 20, 45, 30,   200, 160, 180, 46, 250,    25,  50,   160} };

        public static int[][] industry_farm = { new int [] {250, 50, 0,   90, 10,  0, 0,    70, 200, 225, 30, 180,   0, 175,    25},
                                                new int [] { 55, 25, 0,   30, 60, 10, 0,   120, 400, 500, 50, 210,   0, 180,   100} };

        // The bounding box for a forest plantation is small
        public static int[][] industry_forest = { new int [] {160, 50, 0,   90, 10,  0, 0,    90, 30, 40, 40, 180,   0, 210,    25},
                                                  new int [] { 45, 20, 0,   30, 60, 10, 0,   130, 75, 80, 50, 220,   0, 200,   100} };

        public static int[][] industry_ore = { new int [] {80, 50, 0,   18, 60, 20,  2,   180, 200, 200, 80, 240,   400, 500,    75},
                                               new int [] {40, 30, 0,   15, 40, 35, 10,   240, 210, 280, 60, 300,   300, 475,   100} };

        public static int[][] industry_oil = { new int [] {80, 50, 0,   15, 60, 23,  2,   200, 200, 250, 60, 300,   450, 375,    75},
